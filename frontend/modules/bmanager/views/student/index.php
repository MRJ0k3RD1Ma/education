...
//                    'id',
                    [
                        'attribute'=>'code',
                        'value'=>function($d){
                            $url = Yii::$app->urlManager->createUrl(['/bmanager/student/view','id'=>$d->id]);
                    ...
                    [
                        'attribute'=>'group_id',
                        'value'=>function($d){
                            $url = Yii::$app->urlManager->createUrl(['/bmanager/groups/view','id'=>$d->group_id]);
                    ...
                    [
                        'attribute'=>'person_id',
                        'value'=>function($d){
                            $url = Yii::$app->urlManager->createUrl(['/bmanager/person/view','id'=>$d->person_id]);
