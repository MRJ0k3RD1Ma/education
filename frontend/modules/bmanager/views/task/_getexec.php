<div class="row">
    <div class="col-md-4">
        <div class="form-group field-taskuser-exec_id required has-error">
            ...
            <select id="taskuser-exec_id" class="form-control" name="TaskUser[<?= $key?>][exec_id]" aria-required="true"
                    aria-invalid="true">
    ...
    <div class="col-md-4">
        <div class="form-group field-taskuser-deadline">
            ...
            <input type="date" id="taskuser-deadline" class="form-control" name="TaskUser[<?= $key?>][deadline]">
    ...
    <div class="col-md-4">
        <div class="form-group field-taskuser-type_id">
            ...
            <select id="taskuser-type_id" class="form-control" name="TaskUser[<?= $key?>][type_id]">
