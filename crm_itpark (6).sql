...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 20 2022 г., 16:36
...
--
-- Дамп данных таблицы `task_answer`
--

INSERT INTO `task_answer` (`task_id`, `user_id`, `detail`, `id`, `created`, `updated`, `status_id`, `comment`, `confirm_id`) VALUES
(29, 8, 'asdasd', 1, '2022-12-20 16:57:50', '2022-12-20 17:11:27', 1, 'Commont dsfsd;lfjkdlfkgjldkfjgldkfjglkdfjglkdfjglkfg', NULL),
(29, 8, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto incidunt nihil nobis quo vitae. Iusto magni maxime minus officiis praesentium quod temporibus? Aliquam consectetur, culpa dolorem enim eveniet ex excepturi laborum laudantium magni maxime odit perspiciatis quas quis recusandae repellendus sed tenetur ullam? Amet dolores esse fuga fugit id neque nesciunt reiciendis! Aliquam aliquid asperiores assumenda autem blanditiis commodi corporis cum deserunt dicta doloribus eaque, esse ex expedita illum incidunt itaque laborum minima nobis non nulla optio pariatur perferendis perspiciatis praesentium quasi quia quisquam quod recusandae repellat repellendus reprehenderit repudiandae sequi sint sit suscipit velit veniam? Consequuntur earum fugiat quam.', 2, '2022-12-20 17:09:23', '2022-12-20 17:10:50', 1, 'Comment', NULL),
(29, 8, 'sdfsdf', 3, '2022-12-20 17:48:06', '2022-12-20 17:48:06', 1, NULL, NULL);
...
--
-- Дамп данных таблицы `task_answer_file`
--

INSERT INTO `task_answer_file` (`task_id`, `user_id`, `id`, `ans_id`, `created`, `updated`, `file`) VALUES
(29, 8, 1, 1, '2022-12-20 17:09:23', '2022-12-20 17:52:45', '1671538163.97151.pdf'),
(29, 8, 2, 1, '2022-12-20 17:48:06', '2022-12-20 17:52:43', '1671540486.22682.gitignore'),
(29, 8, 3, 2, '2022-12-20 17:48:06', '2022-12-20 17:52:42', '1671540486.23133.pdf'),
(29, 8, 4, 2, '2022-12-20 17:48:06', '2022-12-20 17:52:40', '1671540486.23334.pdf');
...
(1, 'Yangi', '<i class=\"text-danger fa fa-eye-slash\"></i>'),
(2, 'Ko\'rildi', '<i class=\"fa fa-eye text-danger\"></i>'),
(3, 'Qabul qilindi', '<i class=\"text-success fa fa-check-double\"></i>'),
(4, 'Rad qilindi', '<i class=\"text-danger fa fa-circle-xmark\"></i>');
...
(1, 'Yangi', '<i class=\"text-danger fa fa-eye-slash\"></i>'),
(2, 'Ko\'rildi', '<i class=\"fa fa-eye text-danger\"></i>'),
(3, 'Jarayonda', '<i class=\"text-warning fa fa-person-running\"></i>'),
(4, 'Tasdiqlanishi kutilmoqda', '<i class=\"text-primary fa fa-envelope\"></i>'),
(5, 'Bajarilgan', '<i class=\"text-success fa fa-check-double\"></i>'),
(6, 'Rad qilingan', '<i class=\"text-danger fa fa-circle-xmark\"></i>');
...
(8, 'Samandarov Doston', 'xonqat', '$2y$13$4MyttKfJUtVZJ9VtQ0sxSu6noaOFqGuOjXyNnAR5Y6TbodewAJmqC', 4, 2, 1, 1, 2),
...
ALTER TABLE `task_answer_file`
  ADD PRIMARY KEY (`task_id`,`user_id`,`id`,`ans_id`),
